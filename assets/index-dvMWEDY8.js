...
aut aut aut maxime quia temporibus ut omnis`}],Mc=({post:e})=>{const t=Lc.find(n=>n.id===e.userId),i=Tc.filter(n=>n.postId===e.id);return B.jsxs("div",{className:"PostInfo",children:[B.jsxs("div",{className:"PostInfo__header",children:[B.jsx("h3",{className:"PostInfo__title",children:e.title}),B.jsxs("p",{children:[" Posted by  ",B.jsx(zc,{user:t})]})]}),B.jsx("p",{className:"PostInfo__body",children:e.body}),i.length>0?B.jsx(Pc,{comments:i}):B.jsx("b",{"data-cy":"NoCommentsMessage",children:"No comments yet"})]})},Rc=({posts:e})=>B.jsx("div",{className:"PostList",children:e.map(t=>B.jsx(Mc,{post:t},t.id))}),Dc=()=>B.jsxs("section",{className:"App",children:[B.jsx("h1",{className:"App__title",children:"Static list of posts"}),B.jsx(Rc,{posts:Cc})]});em(document.getElementById("root")).render(B.jsx(Dc,{}));
